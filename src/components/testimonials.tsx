...
// --- Data ---
// (Kept the same data as before)
const testimonials = [
  {
    id: 1,
    name: "Sanatan Iyer",
    role: "Ex Podcast and Webmaster Head",
...
// The character limit before the "Read More" button appears
