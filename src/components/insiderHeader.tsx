        ...
        <div className="w-full md:w-1/2 relative flex items-center justify-center p-8 order-1 md:order-2">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
               ...
               <span className="text-xs font-mono uppercase tracking-widest text-zinc-400">Insider Brief</span>
            </div>
            
            <p className="text-xl leading-relaxed text-zinc-300 mb-6">
  An <strong className="text-white">AIChE-VIT Insider</strong> isn’t just a member — they’re the pulse of the chapter. From behind-the-scenes strategy to front-line execution, insiders transform ideas into impact.
</p>
